package ru.garretech.garred.doramatv.flow.movieInfo.adapter
...
import ru.garretech.garred.doramatv.flow.movieInfo.WebPlayerActivity
import ru.garretech.garred.doramatv.flow.movieInfo.MovieSourcesFragment
import ru.garretech.garred.doramatv.flow.movieInfo.SelectQualityFragment
                    ...
                    if (sourceName.contains("vk.com")) {
                        ...
                        fragment.viewModel.getOthersLink(source).subscribe({
                            ...
                            fragment.viewModel.addToHistory().subscribe {
                                notifyItemChanged(selectedSeries)
                                flagWatchedSource(helper)
                                val intent = Intent(fragment.context, WebPlayerActivity::class.java)
