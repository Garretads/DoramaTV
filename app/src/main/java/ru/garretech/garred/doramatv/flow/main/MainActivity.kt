...
import ru.garretech.garred.doramatv.flow.main.adapter.MovieListAdapter
import ru.garretech.garred.doramatv.flow.common.dialog.ConfirmationDialog
import ru.garretech.garred.doramatv.flow.common.view.CustomLoadMoreView
import ru.garretech.garred.doramatv.flow.common.dialog.DisclaimerDialog
import ru.garretech.garred.doramatv.flow.catalog.SortingFragment
import ru.garretech.garred.doramatv.data.model.Movie
import ru.garretech.garred.doramatv.tools.SiteWorker
import ru.garretech.garred.doramatv.flow.main.viewModel.MainActivityViewModel
import java.util.*
...
import ru.garretech.garred.doramatv.flow.profile.AboutApplicationActivity
import ru.garretech.garred.doramatv.flow.catalog.GenresActivity
import ru.garretech.garred.doramatv.flow.movieInfo.MovieInfoActivity
import ru.garretech.garred.doramatv.flow.profile.SettingsActivity
...
class MainActivity : AppCompatActivity(), BaseQuickAdapter.OnItemClickListener, MenuItem.OnActionExpandListener, NavigationView.OnNavigationItemSelectedListener, BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, SortingFragment.OnFragmentInteractionListener {
                ...
                when (activityState) {
                    ACTIVITY_STATE.FAVORITES -> {
                        ...
                        confirmationDialog.setConfirmationListener(object :
                                ConfirmationDialog.OnFragmentInteractionListener {
    ...
    private fun firstStartDisclaimer() {
        ...
        if (isFirstRun) {
            ...
            val disclaimerFragment = DisclaimerDialog()
        ...
        if (currentVersion != savedVersion) {
            ...
            val disclaimerFragment = DisclaimerDialog.newInstance(getString(R.string.changelog))
