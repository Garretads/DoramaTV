package ru.garretech.garred.doramatv.flow.main.viewModel
...
import ru.garretech.garred.doramatv.flow.common.dialog.ProgressBottomSheet
...
class MainActivityViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var observable: Observable<List<Movie>>? = null
